...
export default function AIPPTGeneratorCard() {
  return (
    <Card
      sx={{ maxWidth: { xs: 300, sm: 400, md: 500 }, height:'100%',margin: '20px auto',  backgroundColor: '#191825', color: '#FFFFFF', borderRadius: '15px', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.5)', overflow: 'hidden',':hover': {transform: 'scale(1.05)'}, transform: 'perspective(1px) translateZ(0)',  transition: 'transform 0.3s ease-in-out', }} >
      <CardActionArea>
        ...
        <CardContent>
          <Typography gutterBottom variant="h5" component="div" sx={{ color: '#FFA3FD', textAlign: 'center', paddingTop:'10px' }} > AI PPT Generator </Typography>
            <Typography variant="body2" sx={{ color: '#FFFFFF', textAlign: 'center', paddingTop:'20px' }} >
